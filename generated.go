...
func progpCgoBinding__94(res *C.ProgpFunctionReturnVoid, p1 C.ProgpV8FunctionPtr) {
	...
	modSamples.JsTestEventFunction(getSharedResourceContainerFromUIntPtr(res.currentEvent.id), newV8Function(res.isAsync, p1, res.currentEvent))
...
func progpCgoBinding__51(res *C.ProgpFunctionReturnLong, p1 C.double, p2 *C.s_progp_goStringOut) {
	defer progpAPI.CatchFatalErrors()
...
func progpCgoBinding__49(res *C.ProgpFunctionReturnVoid, p1 C.double) {
	defer progpAPI.CatchFatalErrors()
...
func progpCgoBinding__52(res *C.ProgpFunctionReturnVoid, p1 C.double, p2 *C.s_progp_goStringOut, p3 *C.s_progp_goStringOut, p4 C.ProgpV8FunctionPtr) {
	defer progpAPI.CatchFatalErrors()
